...
Original file is located at
    https://colab.research.google.com/drive/1KYTy6DE91HxIDtiXqffKE9zNSJ4QsTQc
...
#!pip install --user torch torchtext --index-url https://download.pytorch.org/whl/cpu

# Then install other packages
#!pip install --user transformers==4.46.2 trl==0.12.0 datasets==3.1.0

# STEP 1: Clean uninstall everything first (fixes cache issues)
#pip uninstall -y torch torchtext transformers trl datasets

# Core PyTorch ecosystem (latest stable)
#!pip install --user torch==2.4.1 torchtext==0.19.0

# Transformers and RL libraries (latest compatible trio)
#!pip install --user transformers==4.46.2
#!pip install --user trl==0.12.0

# Dataset handling
#!pip install --user datasets==3.1.0

# NLP utilities
#!pip install --user nltk==3.9.1 rouge_score==0.1.2

# Visualization and computation
#!pip install --user matplotlib==3.9.2
#!pip install --user numpy==1.26.4

print("✅ All packages installed with latest compatible versions!")
...
print("Required parameters:", [p for p, v in sig.parameters.items() if v.default == inspect.Parameter.empty])
