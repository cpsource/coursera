...
# download the Canada map fopr reference
import requests
import zipfile
import io
import os
...
# q1 - explore the table

# Strings consisting of two dots '..' indicate missing values. There miight still be empty fields, or NaNs.

# q2 - display the facility types and their counts
print(df.ODCAF_Facility_Type.value_counts())

# q3 filter the data to only include museums

df = df[df.ODCAF_Facility_Type == 'museum']
print(df.ODCAF_Facility_Type.value_counts())

# q4 - display information about the coordinates like counts and data types
