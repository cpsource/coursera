...
# q3 - Comment on the within-cluster sum of squares, i.e. inertia, of the clusters created for k=3 and k=5.Comment on the within-cluster sum of squares, i.e. inertia, of the clusters created for k=3 and k=5.
...
# cusomer segmentation with k-means
...
# exercise 5 - Create a profile for each group, considering the common characteristics of each cluster based on your observations above.
